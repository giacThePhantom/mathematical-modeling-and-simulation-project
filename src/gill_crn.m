...
tau_arr = [];
eps_arr = [];
[V1,M1,N1,t1,Mtot1,Ntot1,tau_arr, eps_arr] = ml_4_gill("../data/gill_params.csv", tau_arr, eps_arr);
disp("here")
times = spike_detection(V1, 0);
...
%[V2,M2,N2,t2,Mtot2,Ntot2] = ml_4_gill("../data/gill_params.csv", tau_arr, eps_arr);
