...
legend("Voltage", 'FontSize',16)


subplot(7, 1, 2)
plot(T, Y(:, 2), 'g', 'LineWidth', 3.0)
legend("InterSpikeTime", 'FontSize',16)

subplot(7, 1, 3)
plot(T, Y(:, 3), 'm', 'LineWidth', 3.0)
legend("SK", 'FontSize',16)

subplot(7, 1, 4)
plot(T, Y(:, 4), 'y', 'LineWidth', 3.0)
legend("AMPA", 'FontSize',16)

subplot(7, 1, 5)
plot(T, Y(:, 5), 'c', 'LineWidth', 3.0)
legend("GABA", 'FontSize',16)

subplot(7, 1, 6)
plot(T, Y(:, 6), 'k', 'LineWidth', 3.0)
legend("NMDA", 'FontSize',16)

subplot(7, 1, 7)
plot(t_array, s_array, 'r', 'LineWidth', 3.0)
legend("Current", 'FontSize',16)
